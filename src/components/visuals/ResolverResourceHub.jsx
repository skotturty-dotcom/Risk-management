        ...
        >
          <div className="lg:col-span-8 space-y-4 relative z-10">
            ...
            <div className="pt-2 flex flex-wrap items-center gap-3">
              <button
                onClick={onOpenAudit}
                className="px-5 py-2.5 rounded-lg bg-[#008579] hover:bg-[#00685E] text-white text-xs font-bold uppercase tracking-wider shadow-md transition-all flex items-center space-x-2 cursor-pointer"
              >
          ...
          {filteredResources.map((res) => {
            ...
            return (
              <motion.div
                ...
                className="p-5 rounded-2xl cursor-pointer border border-teal-500/20 hover:border-[#55D9CC] transition-all duration-300 flex flex-col justify-between group shadow-lg hover:shadow-xl bg-[#06152B] text-white"
              >
                <div className="space-y-3">
                  {/* Top Badges & Category Icon */}
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2">
                      <div className="w-7 h-7 rounded-md bg-[rgba(40,199,183,0.12)] border border-[rgba(72,214,201,0.25)] flex items-center justify-center text-[#55D9CC]">
                        <IconComponent className="w-3.5 h-3.5" />
                      </div>
                      <span className="text-[10px] font-mono font-extrabold uppercase tracking-wider text-[#55D9CC] bg-[rgba(40,199,183,0.10)] px-2 py-0.5 rounded border border-[rgba(72,214,201,0.25)] shadow-sm">
                        {res.tag}
                      </span>
                    </div>
                  ...
                  {/* Description */}
                  <p className="text-xs text-[#CBD5E1] leading-relaxed font-normal line-clamp-3">
                    {res.desc}
                  </p>
                </div>
                ...
                <div className="pt-4 mt-3 border-t border-white/10 flex items-center justify-between">
                  <span className="text-[11px] font-mono text-[#55D9CC] uppercase font-bold tracking-wider">
                    {res.type}
                  </span>
                  <button
                    onClick={onOpenAudit}
                    className="inline-flex items-center space-x-1.5 text-xs font-bold text-[#FFB340] hover:underline cursor-pointer"
                  >
                    <span>Download</span>
                    <ArrowRight className="w-3.5 h-3.5 text-[#FFB340] group-hover:translate-x-1 transition-transform" />
                  </button>
                </div>
              </motion.div>
            );
